...
class LD49PygodotPortTests(unittest.TestCase):
    def test_ld49_port_builds_stage_a_to_g_vertical_slice(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn("window/size/viewport_height=960", project_text)
            ...
            self.assertIn('[node name="ScorePanel" type="VBoxContainer" parent="Shell/VBox"]', main_scene_text)
            self.assertIn('[node name="Counters" type="HBoxContainer" parent="Shell/VBox/ScorePanel"]', main_scene_text)
            self.assertIn('[node name="ScoreLabel" type="Label" parent="Shell/VBox/ScorePanel/Counters"]', main_scene_text)
            self.assertIn('[node name="TurnLabel" type="Label" parent="Shell/VBox/ScorePanel/Counters"]', main_scene_text)
            self.assertIn("size_flags_vertical = 3", main_scene_text)
            self.assertIn("size_flags_stretch_ratio = 8.0", main_scene_text)
            self.assertIn('[node name="CastlePanel" type="Panel" parent="Shell/VBox/BoardPanel"]', main_scene_text)
            self.assertIn("self_modulate = Color(0.42, 0.5, 0.58, 1.0)", main_scene_text)
            self.assertIn('text = "Goal Castle 0/6 D:0 U:0 G:0"', main_scene_text)
            self.assertIn('[node name="MapGrid" type="GridContainer" parent="Shell/VBox/BoardPanel"]', main_scene_text)
            self.assertIn("columns = 5", main_scene_text)
            self.assertIn("size_flags_stretch_ratio = 9.0", main_scene_text)
            self.assertEqual(main_scene_text.count('instance=ExtResource("PackedScene_scenes_tile_tscn")'), 25)
            self.assertIn('[node name="TileA1" parent="Shell/VBox/BoardPanel/MapGrid" instance=ExtResource("PackedScene_scenes_tile_tscn")]', main_scene_text)
            self.assertIn('[node name="TileE5" parent="Shell/VBox/BoardPanel/MapGrid" instance=ExtResource("PackedScene_scenes_tile_tscn")]', main_scene_text)
            self.assertIn('[node name="ActionsPanel" type="VBoxContainer" parent="Shell/VBox"]', main_scene_text)
            self.assertNotIn("SidePanel", main_scene_text)
            self.assertIn('[node name="SpellsPanel" type="HBoxContainer" parent="Shell/VBox/ActionsPanel"]', main_scene_text)
            self.assertIn('[node name="FireballSpell" parent="Shell/VBox/ActionsPanel/SpellsPanel" instance=ExtResource("PackedScene_scenes_spell_tscn")]', main_scene_text)
            self.assertIn('spell_id = "fireball"', main_scene_text)
            self.assertIn('[node name="FrostSpell" parent="Shell/VBox/ActionsPanel/SpellsPanel" instance=ExtResource("PackedScene_scenes_spell_tscn")]', main_scene_text)
            self.assertIn('spell_id = "frost"', main_scene_text)
            self.assertIn('[node name="ShieldSpell" parent="Shell/VBox/ActionsPanel/SpellsPanel" instance=ExtResource("PackedScene_scenes_spell_tscn")]', main_scene_text)
            ...
            self.assertIn("offset_right = 540", main_scene_text)
            self.assertIn("offset_bottom = 960", main_scene_text)
            ...
            self.assertIn('[node name="CloseButton" type="Button" parent="EventLogOverlay/EventLogPanel"]', main_scene_text)
            self.assertIn('[node name="EventLogText" type="TextEdit" parent="EventLogOverlay/EventLogPanel"]', main_scene_text)
            self.assertIn("offset_right = 492", main_scene_text)
            self.assertIn("offset_bottom = 834", main_scene_text)
            self.assertIn("editable = false", main_scene_text)
            self.assertIn("wrap_mode = 1", main_scene_text)
            ...
            self.assertIn("custom_minimum_size = Vector2(116, 52)", spell_scene_text)
            self.assertIn("custom_minimum_size = Vector2(104, 42)", spell_scene_text)
            self.assertIn("custom_minimum_size = Vector2(104, 18)", spell_scene_text)
            ...
            self.assertIn("modulate = Color(0.55, 0.62, 0.67, 1.0)", tile_scene_text)
            self.assertNotIn('text = "Empty"', tile_scene_text)
            self.assertIn("custom_minimum_size = Vector2(86, 32)", tile_scene_text)
            self.assertIn('theme_override_font_sizes = {"font_size": 15}', tile_scene_text)
            ...
            self.assertIn(
                '[connection signal="pressed" from="EventLogOverlay/EventLogPanel/CloseButton" to="." method="_on_event_log_close_pressed"]',
                main_scene_text,
            )
            ...
            self.assertIn("@onready var castle_panel := $Shell/VBox/BoardPanel/CastlePanel", main_script_text)
            ...
            self.assertIn("@onready var event_log_text := $EventLogOverlay/EventLogPanel/EventLogText", main_script_text)
            ...
            self.assertIn("func _on_event_log_close_pressed() -> void:", main_script_text)
            ...
            self.assertIn("event_log_text.set_caret_line", main_script_text)
            ...
            self.assertIn('if to_cell == "CASTLE":', main_script_text)
            self.assertIn('castle_label.text = "Goal <= %s" % display_name', main_script_text)
            self.assertIn('castle_label.text = "Goal reached: %s" % display_name', main_script_text)
            self.assertIn("func _set_castle_preview(role: String, display_name: String) -> void:", main_script_text)
            self.assertIn("func _clear_castle_preview() -> void:", main_script_text)
            ...
            self.assertIn('_refresh_unit("")', tile_script_text)
            self.assertNotIn('_refresh_unit("Empty")', tile_script_text)
            ...
            self.assertIn('return "Goal Castle %d/%d D:%d U:%d G:%d"', game_state_text)
