...
class LD49PygodotPortTests(unittest.TestCase):
    def test_ld49_port_builds_stage_a_to_g_vertical_slice(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn("GameState.resolve_neighbor_traits()", main_script_text)
            ...
            self.assertIn("func _show_movement_preview(previews: Array) -> void:", main_script_text)
            self.assertIn("func _clear_movement_preview() -> void:", main_script_text)
            ...
            self.assertIn("func set_movement_preview(role: String, outcome: String) -> void:", tile_script_text)
            ...
            self.assertIn("func _movement_preview_label(role: String, outcome: String) -> String:", tile_script_text)
            ...
            self.assertIn("func _resolve_neighbor_traits() -> String:", game_state_text)
